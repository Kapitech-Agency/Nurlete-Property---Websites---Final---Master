...
export function Experience() {
 ...
 activeTab === tab.id 
 ? 'bg-white text-[#000000] shadow-[0_4px_16px_rgba(255,255,255,0.2)]' 
 ...
 <div className="absolute top-full left-1/2 -translate-x-1/2 mt-[8px] bg-white text-[#000000] text-[12px] font-bold px-[12px] py-[6px] rounded-[8px] opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
 Unit A{i+1} • {marker.status}
 </div>
 </div>
 ))}
 </div>
 <div className="absolute bottom-[24px] left-[24px] bg-[#000000]/80 backdrop-blur-md p-[16px] rounded-[16px] border border-white/10 flex gap-[16px]">
 ...
 <a href={`https://wa.me/6282239415718?text=Hello,%20I'm%20interested%20in%20a%20property%20priced%20at%20${formatIDR(price)}.`} target="_blank" rel="noreferrer" className="bg-white text-[#000000] px-[32px] py-[16px] rounded-full font-bold flex items-center justify-center gap-[8px] hover:scale-105 active:scale-95 transition-all">
 ...
 <a href="https://wa.me/6282239415718?text=Hello,%20I%20would%20like%20to%20schedule%20a%20private%20tour%20of%20Nava%20Terra." target="_blank" rel="noreferrer" className="inline-flex bg-white text-[#000000] px-[32px] py-[16px] rounded-full font-bold items-center justify-center gap-[8px] hover:scale-105 active:scale-95 transition-all min-w-[200px]">
 ...
 <div key={i} className={`aspect-square flex items-center justify-center rounded-full ${i === 14 ? 'bg-white text-[#000000]' : i > 10 && i < 20 ? 'bg-white/10 text-white' : 'text-white/40'}`}>
 {i + 1}
 </div>
 ))}
 </div>
