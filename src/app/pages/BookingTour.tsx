...
export default function BookingTour() {
 ...
 <div className="inline-flex items-center gap-[8px] px-[16px] py-[8px] rounded-full bg-white/80 backdrop-blur-xl border border-[#3C2A21]/20 mb-[24px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_4px_12px_rgba(0,0,0,0.03)] min-h-[44px]">
 <span className="w-[8px] h-[8px] rounded-full bg-[#000000] shadow-[0_0_8px_rgba(0,0,0,0.3)]" />
 <span className="text-[#000000]/80 font-bold uppercase tracking-[0.2em] text-[11px] leading-none">Private Showings</span>
 </div>
 <h1 className="font-['Inter'] text-[36px] md:text-[56px] leading-[1.2] md:leading-[1.1] font-semibold text-[#000000] tracking-tight mb-[24px]">Book a Private Tour</h1>
 <p className="font-['Inter'] text-[#000000]/50 text-[15px] md:text-[16px] leading-[1.6] font-medium max-w-2xl mx-auto w-full">
 ...
 className="flex flex-col lg:col-span-7 w-full bg-white/80 backdrop-blur-[60px] border border-[#000000]/[0.05] rounded-[32px] md:rounded-[48px] p-[32px] md:p-[48px] shadow-[0_32px_80px_rgba(0,0,0,0.05),inset_0_1px_1px_rgba(255,255,255,1)]"
 >
 {isSubmitted ? (
 ...
 <h3 className="font-semibold text-[#000000] text-[28px] mb-[16px]">Tour Requested</h3>
 <p className="text-[#000000]/60 font-medium max-w-md mb-[32px]">Your private tour request has been securely submitted. Our sales director will process it shortly.</p>
 ...
 <h3 className="font-semibold text-[#000000] text-[18px] flex items-center gap-[12px]"><CalendarDays size={20} className="text-[#000000]/40" /> Select Date</h3>
 <span className="text-[#000000]/40 font-bold text-[12px] uppercase tracking-wider">May 2026</span>
 </div>
 <div className="grid grid-cols-7 gap-[8px] md:gap-[12px]">
 {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((d, i) => (
 <div key={i} className="text-center font-bold text-[12px] text-[#000000]/30 uppercase mb-[8px]">{d}</div>
 ))}
 {days.map((date) => (
 <button
 type="button"
 ...
 selectedDate === date 
 ? 'bg-[#000000] text-white shadow-[0_8px_24px_rgba(0,0,0,0.3)] scale-105' 
 : 'bg-white border border-[#3C2A21]/20 text-[#000000] hover:border-[#000000]/30 hover:bg-[#000000]/5'
 }`}
 >
 {date}
 </button>
 ...
 {/* Time Picker */}
 <div className="mb-[40px]">
 <h3 className="font-semibold text-[#000000] text-[18px] flex items-center gap-[12px] mb-[20px]"><Clock size={20} className="text-[#000000]/40" /> Select Time</h3>
 ...
 selectedTime === time 
 ? 'bg-[#000000] text-white border-[#000000] shadow-[0_8px_24px_rgba(0,0,0,0.3)] scale-[1.02]' 
 : 'bg-white border-[#3C2A21]/20 text-[#000000]/70 hover:border-[#000000]/30 hover:bg-[#000000]/5'
 }`}
 >
 {time}
 </button>
 ...
 <h3 className="font-semibold text-[#000000] text-[18px] flex items-center gap-[12px] mb-[20px]"><User size={20} className="text-[#000000]/40" /> Your Details</h3>
 <input type="text" placeholder="Full Name" required className="w-full bg-white/50 backdrop-blur-md border border-[#3C2A21]/20 rounded-[20px] px-[24px] py-[16px] min-h-[56px] focus:outline-none focus:border-[#000000]/30 focus:bg-white focus:shadow-[0_8px_24px_rgba(0,0,0,0.05)] transition-all font-medium placeholder:text-[#000000]/40 text-[#000000] shadow-[inset_0_1px_2px_rgba(0,0,0,0.02)]" />
 ...
 className="mt-auto w-full bg-[#000000] text-white rounded-[20px] py-[20px] font-bold text-[16px] transition-all shadow-[0_16px_32px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.2)] hover:shadow-[0_24px_48px_rgba(0,0,0,0.3)] hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none min-h-[56px]"
 >
 Confirm Appointment
 </button>
 </form>
 ...
 >
 {/* Express VIP Contact */}
 <div className="w-full bg-[#000000] text-white rounded-[32px] md:rounded-[48px] p-[40px] md:p-[48px] shadow-[0_32px_80px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.1)] relative overflow-hidden flex flex-col justify-center items-center text-center selection:bg-white selection:text-[#000000]">
 ...
 {/* Support Info */}
 <div className="w-full bg-white/80 backdrop-blur-[40px] border border-[#000000]/[0.05] rounded-[32px] p-[40px] shadow-[0_16px_40px_rgba(0,0,0,0.02),inset_0_1px_1px_rgba(255,255,255,1)]">
 <h3 className="font-['Inter'] text-[#000000] font-semibold text-[20px] leading-[1.3] mb-[32px]">Direct Contact</h3>
 
 <div className="space-y-[24px]">
 <div className="flex items-start gap-[16px] text-[#000000]/60 font-medium text-[15px] leading-[1.6]">
 <MapPin size={24} className="shrink-0 text-[#000000]/40 mt-[2px]" />
 <div>
 <strong className="text-[#000000] block mb-[4px]">Nava Terra Site</strong>
 Jl. PHB Halong Atas<br/>Ambon, Maluku 97231
 </div>
 </div>
 <div className="flex items-center gap-[16px] text-[#000000]/60 font-medium text-[15px] leading-[1.6] min-h-[44px]">
 <Phone size={24} className="shrink-0 text-[#000000]/40" />
 <p>{contactNumber}</p>
 </div>
 <div className="flex items-center gap-[16px] text-[#000000]/60 font-medium text-[15px] leading-[1.6] min-h-[44px]">
 <Mail size={24} className="shrink-0 text-[#000000]/40" />
 ...
 <div className="text-center mb-[64px] md:mb-[96px] w-full">
 <h2 className="font-['Inter'] text-[28px] md:text-[40px] leading-[1.2] font-semibold text-[#000000] tracking-tight mb-[16px]">Viewing Policies & FAQ</h2>
 </div>

 <div className="space-y-[24px] w-full">
 {faqs.map((faq, idx) => (
 <div key={idx} className="w-full bg-white/80 backdrop-blur-[40px] border border-[#000000]/[0.05] rounded-[24px] overflow-hidden shadow-[0_8px_24px_rgba(0,0,0,0.02),inset_0_1px_1px_rgba(255,255,255,1)]">
 <button 
 onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
 className="w-full flex items-center justify-between p-[32px] text-left min-[64px] focus:outline-none"
 >
 <span className="font-['Inter'] font-bold text-[16px] md:text-[18px] leading-[1.5] text-[#000000] pr-[16px]">{faq.question}</span>
 <ChevronDown size={24} className={`shrink-0 text-[#000000]/50 transition-transform duration-300 ${openFaq === idx ? 'rotate-180 text-[#000000]' : ''}`} />
 </button>
 ...
 >
 <div className="p-[32px] pt-0 border-t border-[#3C2A21]/10 mt-[8px]">
 <p className="font-['Inter'] text-[15px] md:text-[16px] leading-[1.6] text-[#000000]/60 font-medium mt-[16px] w-full">{faq.answer}</p>
 </div>
 </motion.div>
 )}
 </AnimatePresence>
